...
public class AlarmClock {
    ...
    private int minute;
    /**
     * 每周开启天的标记 依次为 sun. mon. thu. wed. thu. fri. sat. 的开启状态 如：周一 ~ 五 开启，则为：[false, true, true, true, true, true, false]
     */
    private Boolean[] enableDaysInWeek;
    /**
     * 浅睡眠提醒秒数。会在闹钟时间前 x 秒内的浅睡眠提前振动。如设置了 600s，即为 10 分钟，闹钟时间在 8:00，则会在 7:50 ~ 8:00 之间的浅睡眠中振动
     */
    private int lightSleepSeconds;
